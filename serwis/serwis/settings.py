...
DATABASES = {
    'default': {
        ...
        'NAME': 'PWRTracker',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'yec0w4bemi6egccpdb03#fa23x0bf_d4=(7pwd6r*)w1*151x4'
...
MIDDLEWARE_CLASSES = (
    ...
    'django.middleware.locale.LocaleMiddleware',			#ma byc po polsku
